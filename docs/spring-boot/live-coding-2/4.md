...
:::info Az ApiResponses annotációban a value egy tömböt vár, viszont a kotlin sajátosságai miatt, egyetlen ApiResponse esetén akár el is hagyható az egész tömb és csak egy ApiResponse-t adunk meg. :::
